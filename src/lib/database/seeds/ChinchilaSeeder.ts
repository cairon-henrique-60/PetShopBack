...
export default class ChinchilasBreedSeeder implements Seeder {
  ...
  async run(
    ...
    const breedInsertPromises = chinchillaBreeds.map(async (breedName) => {
